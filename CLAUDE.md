...
- Keep `MEMORY.md` tight: aim under ~2200 chars (and `USER.md` under ~1375) as a soft guardrail, trimming as you go; the weekly prune does the deeper curation. Facts, not narrative.
